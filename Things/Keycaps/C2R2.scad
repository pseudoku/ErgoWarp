...
pathtraj   = [
                ...
                trajectory(forward = 4, pitch = -65, roll = 0),
                trajectory(forward = 11, pitch = 25, roll = 0),
              ];

pathtraj2   = [
                trajectory(forward = 6, pitch = 17 , roll = 0),
                trajectory(forward = 5, pitch = -100, roll = 0),
               trajectory(forward = 10, pitch = -10, roll = 0)
              ];
...
translate([3,5.2,0])linear_extrude(10)scale(.25)text("F", font = "Yu Mincho:style=Demibold", valign = "center", halign = "center");
}
//    #translate([0,0,8])rotate([00,-90,-90])rotate(tilt)skin(clip2);
//    #translate([0,0,8])rotate([0,-90,90])rotate(tilt)skin(clip);
