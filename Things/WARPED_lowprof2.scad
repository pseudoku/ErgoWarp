...
ThumbPosition = [//[[thetaDist, thetaMed, thetaProx, phiProx][rotation angle][rotation angle][translation vec]]
  [[6,23,24.8+shiftAngle ,1], //tip 1 R0  
...
//      }
      ...
      ///TOPs
      rotate([0,0,-0])translate([11,0, height])cube([52,30,10], center = true);  //top box
...
//BaseTrans()for(i = [0:7])PlaceOnThumb(Rn = i)SwitchLow();
