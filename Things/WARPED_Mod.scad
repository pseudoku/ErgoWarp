...
thetaOffsetR3 = -90; //normal to path 
...
[
  [ //C0
    ...
    [knocker_shift+5,switchButtonTopHeight+keycapOffsetHeight[C0],0], //R3
  ...
  [ //C1
    ...
    [knocker_shift ,switchButtonTopHeight+keycapOffsetHeight[C1],0], //R3
  ...
  [ //C2
    ...
    [knocker_shift ,switchButtonTopHeight+keycapOffsetHeight[C2],0], //R3
  ...
  [ //C3
    ...
    [knocker_shift ,switchButtonTopHeight+keycapOffsetHeight[C3],0], //R3
  ...
  [ //C4
    ...
    [knocker_shift ,switchButtonTopHeight+keycapOffsetHeight[C4],0], //R3
  ...
  [ //C5
    ...
    [knocker_shift ,switchButtonTopHeight+keycapOffsetHeight[C5],0], //R3
  ...
  [ //C6
    ...
    [knocker_shift ,switchButtonTopHeight+keycapOffsetHeight[C6],0], //R3
